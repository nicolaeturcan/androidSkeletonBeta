...
public class LoginActivity extends FragmentActivity implements OnClickListener,
		...
		LoginActivityFragment.OnFragmentInteractionListener {
	...
	/*
	 * private static final int SOCIAL_LOGIN_GOOGLE = 101; private static final
	 * int SOCIAL_LOGIN_FACEBOOk = 102; private static final int
	 * SOCIAL_LOGIN_TWITTER = 103;
	 */
	 ...
	 * */
	static String TWITTER_CONSUMER_KEY = "dZYxQGxVGIeq4HwPfdyTtNHCf";
	static String TWITTER_CONSUMER_SECRET = "zthvsJS1u04dg4PIcFeLUu1bTGLnjpiRyc4s2xaZiWm8oe1FEG"; // place
																									// your
																									// consumer
																									// secret
																									// here
	...
	static final String TWITTER_CALLBACK_URL = "oauth://com.iesebre.dam2.pa201415.nicolae";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			getSupportFragmentManager()
					.beginTransaction()
					.add(R.id.login_activitycontainer,
	...
	protected void onResumeFragments() {
		 ...
		 * else if (userSkippedLogin) { showFragment(SELECTION, false); }
		 */else {
		...
		case REQUEST_CODE_FACEBOOK_LOGIN:
			...
			if (responseCode == RESULT_OK) {
				...
				if (revoke == true) {
					...
					progressDialog = new ProgressDialog(LoginActivity.this);
					new Request(session, "/me/permissions", null,
							HttpMethod.DELETE, new Request.Callback() {
	...
	public void onClick(View v) {
		...
		case R.id.btn_google_sign_in:
			...
			break;
		/*
		 * NOTE: Facebook have a custom button! case R.id.btn_facebook_sign_in:
		 * // Signin with Twitter button clicked loginToFacebook(); break;
		 */
	...
	private boolean already_have_twitter_tokens() {
		if (mSharedPreferences.contains(PREF_KEY_OAUTH_TOKEN)
				&& mSharedPreferences.contains(PREF_KEY_OAUTH_SECRET)) {
			return true;
		} else {
			return false;
		}
